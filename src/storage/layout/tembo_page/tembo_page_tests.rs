...
fn test_movements() {
    ...
    let write_tembo_header = write_to_file(&mut file, &get_tembo_header_bytes, (PAGE_SIZE as u64 ) - 1);
    ...
    assert_eq!(tembo_page_header.free_start, size_of::<TemboPageHeader>() as u16);
